...
example-based candidate cadence, historical checkpoints generated by the same
run, four-shard learner batches, and policy-surprise sample weights. Historical
models and deterministic heuristic opponents never import data into replay.
